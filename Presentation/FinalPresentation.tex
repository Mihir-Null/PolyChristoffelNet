...
\begin{frame}{Training: Backprop + Computational Graph + Pytorch}
...
\begin{frame}{Gradient signal on Christoffel coefficients}
...
\begin{frame}(Christoffel Diagnostics w/AutoEncoder)
  \begin{figure}
